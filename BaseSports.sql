...
-- Volcando estructura para tabla sports_time.asistance
...
-- Volcando datos para la tabla sports_time.asistance: ~19 rows (aproximadamente)
...
INSERT INTO asistance (Date1, Name_Athele, State, Name_Coach, Jornada) VALUES
	...
	('2018/03/04', 'mario bolaños', 'Asistio', 'Camilo botonero', 'Tarde'),
...
-- Volcando estructura para tabla sports_time.athele_register
...
-- Volcando datos para la tabla sports_time.athele_register: ~12 rows (aproximadamente)
...
-- Volcando estructura para tabla sports_time.coach_register
...
-- Volcando datos para la tabla sports_time.coach_register: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla sports_time.comments
...
-- Volcando datos para la tabla sports_time.comments: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla sports_time.comment_user
...
-- Volcando datos para la tabla sports_time.comment_user: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla sports_time.eventos: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla sports_time.events: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `events` DISABLE KEYS */;
/*!40000 ALTER TABLE `events` ENABLE KEYS */;

-- Volcando estructura para tabla sports_time.requests
...
-- Volcando datos para la tabla sports_time.requests: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `requests` DISABLE KEYS */;
INSERT INTO requests (user1, destiny, state1) VALUES
	('g', 'g', 'f');
/*!40000 ALTER TABLE `requests` ENABLE KEYS */;

-- Volcando estructura para tabla sports_time.routing
...
-- Volcando datos para la tabla sports_time.routing: ~18 rows (aproximadamente)
...
-- Volcando estructura para tabla sports_time.times
CREATE TABLE IF NOT EXISTS times (
  ID_Time integer DEFAULT NULL,
  ID_Routing integer DEFAULT NULL,
  ID_Athele varchar(100) DEFAULT NULL,
  Time1 varchar(100) DEFAULT NULL
) ;

-- Volcando datos para la tabla sports_time.times: ~63 rows (aproximadamente)
...
INSERT INTO times (ID_Time, ID_Routing, ID_Athele, Time1) VALUES
	...
	(44, 3, 'mario bolaños', '0:0:06:17'),
	(44, 3, 'diego leon', '0:0:05:03'),
	(44, 3, 'mario bolaños', '0:0:02:98'),
	(44, 3, 'amaya leon', '0:0:01:85'),
	(44, 3, 'mario bolaños', '0:0:06:42'),
	(44, 3, 'diego leon', '0:0:04:64'),
	(44, 3, 'mario bolaños', '0:0:02:88'),
	(44, 3, 'amaya leon', '0:0:01:96'),
	(44, 3, 'mario bolaños', '0:0:06:15'),
	(44, 3, 'diego leon', '0:0:04:16'),
	(44, 3, 'mario bolaños', '0:0:02:51'),
	(44, 3, 'amaya leon', '0:0:01:49'),
	(44, 3, 'mario bolaños', '0:0:05:89'),
	(44, 3, 'diego leon', '0:0:05:66'),
	(44, 3, 'mario bolaños', '0:0:05:14'),
	(44, 3, 'amaya leon', '0:0:04:44'),
...
SELECT * FROM times WHERE ID_Time=34 AND ID_Athele='andres leon'; 
